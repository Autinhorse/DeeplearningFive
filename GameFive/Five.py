...
from GameFive.BoardFive import BoardFive
...
class MainWindow(QWidget):
    ...
    def StartGame(self):
        ...
        self.player1 = RobotFiveRandom01(PlayerColor.BLACK)
        #self.player1.rate = 0
        #self.player2 = RobotFiveMCTS(PlayerColor.WHITE)
        self.player2 = RobotFiveRandom01(PlayerColor.WHITE)
    ...
    def DoTest1(self):
        ...
        player2 = RobotFiveRandom01(PlayerColor.WHITE)

        pool = AutoRobotArenaPool(player1=player1, player2=player2, game=GameFive(), board=None, beginColor=PlayerColor.BLACK,
    ...
    def DoTestBundle(self):
        player1 = RobotFiveRandom01(PlayerColor.BLACK)
        player2 = RobotFiveRandom02(PlayerColor.WHITE)
        ...
        for i in range(0, 201):
            ...
            if rate2 > 1.0:
                break
            player2.rate = rate2
            pool = AutoRobotArenaPool(player1=player1, player2=player2, board=None, beginColor=PlayerColor.BLACK,
